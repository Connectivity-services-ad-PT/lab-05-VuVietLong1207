...
build:
	docker build -t fit4110/notification-service:v0.1.0-notify .

# Run API container standalone (not via compose)
run:
	docker run --rm --name fit4110-api-lab05 -p 8000:8000 --env-file .env.example fit4110/notification-service:v0.1.0-notify
